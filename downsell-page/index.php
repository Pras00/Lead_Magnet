...
<body>
    ...
    <div class="container-lg bg-2">
        <div class="flex flex-col items-center justify-center text-center p-3 py-16">
            <h1 class="inter-regular font-3rem mt-0 md:mt-12 w-full md:w-[70%]">
            ...
            <h3 class="inter-regular font-1-5rem mt-12 w-full md:w-[70%]">
                While you currently possess the <span class="text-[#352CE8]">personal use license</span>, by upgrading to the<span class="text-[#352CE8]"> commercial license for Lead Plus+, </span>you'll unlock the ability to craft stunning quote videos for your clients, keeping all profits.
            </h3>
    ...
    <div class="container-lg bg-pink">
        <div class="flex flex-col items-center justify-center px-5">
            <div class="border-0 bg-white drop-shadow-lg rounded-2xl m-12 md:m-24 px-4 md:px-6 lg:px-8 py-8 md:py-16 w-full md:w-[70%] flex flex-col items-center justify-center text-center inter-regular">
                <h3 class="inter-bold font-2-5rem">
                    LIMITED TIME OFFER!!!
                </h3>

                <p class="font-2rem mt-16">
