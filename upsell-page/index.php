...
<body>
    ...
    <div class="container-lg bg-2">
        <div class="flex flex-col items-center justify-center text-center p-3 py-16">
            <h1 class="inter-regular font-3rem mt-0 md:mt-12">
                ...
                Receive an Exclusive PLR License with <br> Additional Content!
            </h1>
            <h3 class="inter-regular font-1-5rem mt-12 w-full md:w-[80%]">
                While you currently possess the
                <span class="text-[#352CE8]"> Resell Right license, </span>
                by upgrading to the 'Extended' Version you get 
                <span class="text-[#352CE8]">Private label right license (PLR) </span>
                for Lead Plus+,you'll unlock the ability to Edit, Rebrand and Resell it, keeping all the profits.
            </h3>

            <img class="p-5 w-full md:w-[120%]" src="img/BoxMockup3 2.png" alt="">

            <h3 class="inter-regular font-2rem mb-12 w-full md:w-[80%]">
                Unlock Unlimited Potential with Our Exclusive PLR Digital Product <span class="text-[#352CE8]">Lead Magnet</span> for Resellers!
            </h3>
            <h4 class="inter-regular font-1-5rem w-full md:w-[80%] mb-16">
                Are you ready to revolutionize your reselling business and amplify your profits? Introducing our premium Digital Product <span class="text-[#352CE8]">Lead Magnet</span> – the ultimate solution designed exclusively for resellers like you, now available with a flexible Private Label Rights (PLR) license!
            </h4>
                ...
                <div class="border-0 bg-white drop-shadow-lg rounded-2xl px-4 md:px-6 lg:px-0 h-full md:h-[70%]">
                    ...
                    <div class="p-3 md:p-8 text-black">
                        ...
                        <div class="flex flex-row items-center justify-center mt-12">
                            <h3 class="font-1-5rem inter-regular ms-3">
                                Total Value = <span class="text-[#FF0000]">$10.125</span>
                            </h3>
                        </div>
                    </div>
                </div>
                <div class="border-0 bg-white drop-shadow-lg rounded-2xl px-4 md:px-6 lg:px-0">
                    <h1 class="bg-payment-2 rounded-lg inter-regular text-black font-2rem p-5">
    ...
    <div class="container-lg bg-2">
        <div class="flex flex-col items-center justify-center text-center py-12">
            <h2 class="inter-regular font-2-5rem w-full md:w-[50%]">
                Why Upgrade to <span class="text-[#352CE8]">LEAD MAGNET</span> Extended Version?
            </h2>

            <img class="w-[80%] md:w-[25%] mt-8" src="img/img-why.png" alt="">

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 grid-rows-3 gap-5 mb-16 text-black p-5 w-full md:w-[70%]">
                <div class="border-0 bg-white drop-shadow-lg rounded-2xl px-4 md:px-6 lg:px-12 py-8 w-full flex flex-col md:flex-row items-center justify-start">
                    <div class="flex items-center justify-center mt-4 md:mt-0 md:order-first">
                        <img class="w-[255px] md:w-[1155px] mb-4 md:mb-0" src="img/img-why-1.png" alt="">
                    </div>
                    <div class="flex flex-col justify-center text-center md:text-start md:ms-8 inter-regular">
                        <h1 class="font-2rem text-[#352CE8] mb-5 md:mb-8">Diverse Quote Selection</h1>
                        <h3 class="font-1-2rem text-justify">
                            Gain access to a wide array of quote templates, including both Feed and Story sizes for Instagram. This upgrade offers a vast collection of quotes in various niches, doubling your creative possibilities and enabling you to craft compelling content for your social media.
                        </h3>
                    </div>
                </div>
                <div class="border-0 bg-white drop-shadow-lg rounded-2xl px-4 md:px-6 lg:px-12 py-8 w-full flex flex-col md:flex-row items-center justify-start">
                    <div class="flex items-center justify-center mt-4 md:mt-0 md:order-last">
                        <img class="w-[75px] md:w-[455px]" src="img/img-why-2.png" alt="">
                    </div>
                    <div class="flex flex-col justify-center text-center md:text-start md:me-8 inter-regular">
                        <h1 class="font-2rem text-[#352CE8] mb-5 md:mb-8">Maximize Your Social Media Presence</h1>
                        <h3 class="font-1-2rem text-justify">
                            Unlock the Developer Rights License with the Platinum Version, allowing you to use the quote templates for your clients' social media projects. This opens up unlimited profit potential, as you can sell the completed projects to them. With Quotes Buddy 2.0 Platinum, you can charge premium rates for your services.
                        </h3>
                    </div>
                </div>
                <div class="border-0 bg-white drop-shadow-lg rounded-2xl px-4 md:px-6 lg:px-12 py-8 w-full flex flex-col md:flex-row items-center justify-start">
                    <div class="flex items-center justify-center mt-4 md:mt-0 md:order-first">
                        <img class="w-[255px] md:w-[1155px]" src="img/img-why-3.png" alt="">
                    </div>
                    <div class="flex flex-col justify-center text-center md:text-start md:ms-8 inter-regular">
                        <h1 class="font-2rem text-[#352CE8] mb-5 md:mb-8">Greater Template Variety, Greater Engagement</h1>
                        <h3 class="font-1-2rem text-justify">
            ...
            <img class="w-[90%] md:w-[55%]" src="img/price.png" alt="">
        </div>
    </div>
    ...
    <div class="container-lg bg-3 drop-shadow-lg rounded-b-2xl">
        <div class="flex flex-col items-center justify-center py-12 text-center text-white">
            ...
            <img class="w-[10%] md:w-[3%] mt-5" src="img/arrow-down-2.png" alt="">
        </div>
    </div>
    ...
    <div class="bg-4 container-lg p-5 md:p-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 grid-rows-1 gap-5 inter-regular my-12">
            <div class="col-span-1 flex justify-center items-center">
                <div class="grid grid-cols-1 gap-5">
                    <div class="bg-rental-2 py-8 px-8 text-black">
                        <h1 class="inter-medium font-1-5rem mb-3">Cosmetic Store</h1>
                        <p class="inter-regular font-0-8rem text-justify">
    ...
    <div class="bg-4 container-lg p-5 md:p-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 grid-rows-1 gap-5 inter-regular my-12">
            <div class="col-span-1 flex justify-center items-center">
                <div class="grid grid-cols-1 gap-5">
                    <div class="bg-rental-2 py-5 px-8 text-black">
    ...
    <div class="bg-5 container-lg p-5 md:p-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 grid-rows-1 gap-5 inter-regular my-12">
            ...
            <div class="col-span-1 flex justify-center items-center">
                <div class="grid grid-cols-1 gap-5">
                    <div class="bg-rental-2 py-8 px-8 text-black">
                        <h1 class="inter-medium font-1-5rem mb-3">Seamstress</h1>
                        <p class="inter-regular font-1rem text-justify">Passionate about textiles? Transform Fabric into Profitable Art!
    ...
    <div class="bg-4 container-lg p-5 md:p-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 grid-rows-1 gap-5 inter-regular my-12">
            <div class="col-span-1 flex justify-center items-center">
                <div class="grid grid-cols-1 gap-5">
                    <div class="bg-rental-2 py-8 px-8 text-black">
                        <h1 class="inter-medium font-1-5rem mb-3">Boutique Fashion</h1>
    ...
    <div class="bg-5 container-lg p-5 md:p-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 grid-rows-1 gap-5 inter-regular my-12">
            ...
            <div class="col-span-1 flex justify-center items-center">
                <div class="grid grid-cols-1 gap-5">
                    <div class="bg-rental-2 py-3 px-8 text-black">
    ...
    <div class="container-lg bg-1">
        <div class="flex flex-col items-center justify-center px-5">
            <div class="border-0 bg-white rounded-2xl m-12 md:m-24 px-4 md:px-6 lg:px-8 py-8 md:py-16 w-full md:w-[70%] flex flex-col items-center justify-center text-center inter-regular">
                ...
                <h5 class="font-2rem">
                    Quotes Buddy 2 'Extended' + PLR License
                </h5>

                <p class="font-1-5rem mt-8">
                    You get more content and able to resell under your own brand
                </p>

                <!-- <img class="w-[100%] md:w-[55%] my-8" src="img/limited.png" alt=""> -->

                <h1 class="font-2rem mt-16">
                    Secure Your Special Price for Only <span class="line-through">  $97 $67 $47</span> <br>
                    <span class="inter-bold font-2-5rem text-[#FF0000]">JUST $37</span>
                </h1>

                <div class="m-16"></div>

                <div class="border-0 bg-[#FF0000] rounded-lg px-3 md:px-5 lg:px-5 py-3 md:py-5 w-full md:w-[70%] flex flex-col items-center justify-center text-center inter-bold text-white">
